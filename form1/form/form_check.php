...
#----------------------------------------------------------------------------------
//$error_mes .= Chk_InputMode($your_name,"・お名前をご記入ください。<br />\n");

//$error_mes .= Chk_InputMode($tel,"・電話番号をご記入ください。<br />\n");

//$error_mes .= Chk_InputMode($email,"・メールアドレスをご記入ください。<br />\n");

//$error_mes .= Chk_InputMode($visit,"・ご来場人数をご記入ください。<br />\n");

//$error_mes .= Chk_InputMode($visit_day,"・ご来場予定日を選択してください。<br />\n");

//$error_mes .= Chk_InputMode($riyu,"・内容に不備がございます。<br />\n");
